...
(21, 'Perferendis esse of', '', 'losoj', 'Dolorum ex voluptas ', 'Perempuan', '0612348', '7901234', '9ac311b49462dc2684aa222c1d8cbba8', 2),
(22, 'Fugit sint tenetur ', '', 'gyrakubal', 'Natus rerum earum ve', 'Laki-laki', '6819234', '162894', '83f9c340ad4669051572b1754a2a7b9a', 2);
...
CREATE TABLE `transaksi` (
  `id_rental` int(11) NOT NULL,
  `kode_rental` varchar(15) NOT NULL,
  `id_customer` int(11) NOT NULL,
  `id_mobil` int(11) NOT NULL,
  `nama_rental` varchar(120) NOT NULL,
  `tanggal_rental` date NOT NULL,
...
INSERT INTO `transaksi` (`id_rental`, `kode_rental`, `id_customer`, `id_mobil`, `nama_rental`, `tanggal_rental`, `tanggal_kembali`, `harga`, `denda`, `total_denda`, `tanggal_pengembalian`, `status_pengembalian`, `status_rental`, `bukti_pembayaran`, `status_pembayaran`, `tanggal_denda`, `status_denda`) VALUES
(10, '08062020001', 9, 17, 'Sejahtera Travel', '2020-06-08', '2020-06-12', 800000, 100000, '58604166.666667', '2022-01-19', 'Kembali', 'Selesai', '009.PNG', 1, NULL, 0),
(15, '09012022001', 20, 9, 'Putra Riau Travel', '2022-01-09', '2022-01-12', 300000, 45000, '90000', '2022-01-14', 'Kembali', 'Selesai', 'Bukti_Pembayaran_Contoh.jpg', 1, NULL, 0),
(16, '05122022002', 9, 10, 'Putra Riau Travel', '2022-12-05', '2022-12-06', 250000, 30000, '0', NULL, 'Belum Kembali', 'Belum Selesai', '', 0, NULL, 0);
