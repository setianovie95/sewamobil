      <footer class="main-footer">
        <div class="footer-left">
          Copyright &copy; 2022 <div class="bullet"></div> Design By Paisal Rohman, Fathur Rahman, Setia Novie Nuradi, Yusuf Abdul Wahid
        </div>
      ...
      <script src="<?php echo base_url('assets/assets_shop') ?>/js/moment.min.js"></script>
      <script src="<?php echo base_url('assets/assets_shop') ?>/js/jquery.nicescroll.min.js"></script>
