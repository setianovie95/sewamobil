<div class="main-content">
	...
	<form method="POST" action="<?php echo base_url('admin/data_type/tambah_type_aksi') ?>">
		...
		<div class="form-group">
			...
			<input type="text" name="kode_type" value="<?= set_value('kode_type') ?>" class="form-control"> 
        	<?php echo form_error('kode_type','<div class="text-small text-danger">','</div>') ?>
		</div>

		<div class="form-group">
			<label>Nama Type</label>
			<input type="text" name="nama_type" value="<?= set_value('nama_type') ?>" class="form-control"> 
